...
| Location | Purpose |
|----------|---------|
| [`.cursor/rules/`](.cursor/rules/) | Hard guardrails in `.mdc` files (always-on in Cursor): HCP compared to Classic, provider/version constraints, variables, security baseline |
